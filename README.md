...
With the fast development of various positioning techniques such as Global Position System (GPS), mobile devices and
remote sensing, spatio-temporal data has become increasingly available nowadays. Mining valuable knowledge from spatio-temporal
data is critically important to many real-world applications including human mobility understanding, smart transportation, urban
planning, public safety, health care and environmental management.

Contributed by Senzhang Wang, Jinlong Du.

## [Content](#content)

<table>
<tr><td colspan="2"><a href="#survey-papers">1. Survey</a></td></tr>
<tr><td colspan="2"><a href="#Spatio-Temporal-Data">2. Spatio-Temporal Data</a></td></tr>
<tr>
    <td>&emsp;<a href="#event-data">2.1 Event Data</a></td>
    <td>&ensp;<a href="trajectory-data">2.2 Trajectory Data</a></td>
</tr>
<tr>
    <td>&emsp;<a href="#point-reference-data">2.3 Point Reference Data</a></td>
    <td>&ensp;<a href="raster-data">2.4 Raster Data</a></td>
</tr>
<tr>
    <td>&emsp;<a href="#video-data">2.5 Video Data</a></td>
    <td>&emsp;</td>
</tr>
<tr><td colspan="2"><a href="#models">3. Models</a></td></tr>
<tr>
    <td>&emsp;<a href="#cnn">3.1 CNN</a></td>
    <td>&ensp;<a href="#graph-cnn">3.2 Graph CNN</a></td>
</tr>
<tr>
    <td>&emsp;<a href="#rnn/lstm">3.3 RNN/LSTM</a></td>
    <td>&ensp;<a href="#convlstm">3.4 ConvLSTM</a></td>
</tr>
<tr>
    <td>&emsp;<a href="#seq2seq">3.5 AE/SAE</a></td>
    <td>&ensp;<a href="#hybrid">3.6 RBM/DBN</a></td>
</tr>
<tr>
    <td>&emsp;<a href="#ae/sae">3.7 Seq2Seq</a></td>
    <td>&ensp;<a href="#rbm/dbn">3.8 Hybrid</a></td>
</tr>
<tr>
    <td>&emsp;<a href="#others">3.9 Others</a></td>
    <td>&ensp;</td>
</tr>
<tr><td colspan="2"><a href="#applications">4. Applications</a></td></tr> 
<tr>
    <td>&emsp;<a href="#transportation">4.1 Transportation</a></td>
    <td>&ensp;<a href="#on-demand-service">4.2 On-Demand Service</a></td>
</tr> 
<tr>
    <td>&emsp;<a href="#climate-and-weather">4.3 Climate & Weather</a></td>
    <td>&ensp;<a href="#human-mobility">4.4 Human Mobility</a></td>
</tr>
<tr>
    <td>&emsp;<a href="#location-based-social-networks">4.5 Location-Based Social Networks(LBSNs)</a></td>
    <td>&ensp;</td>
</tr>
</table>
...
<!-- 1. **Locally Balanced Inductive Matrix Completion for Demand-Supply Inference in Stationless Bike-Sharing Systems.** [paper](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=8735780) [code](https://github.com/szwangsummer/UBIMC.git)
    ...
    *Senzhang Wang, Hao Chen, Jiannong Cao, Jiawei Zhang, Philip S. Yu.* 
